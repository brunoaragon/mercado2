...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    private function getAddressAttributeValue($address, $attributeId)
    {
        ...
        if ($isStreetline !== false && isset($matches[1])) { //uses streetlines
             $street[1] = $address->getStreetLine(1); //rua
             $street[2] = $address->getStreetLine(2); //numero
             $street[3] = $address->getStreetLine(4); //complemento
             $street[4] = $address->getStreetLine(3); //bairro
